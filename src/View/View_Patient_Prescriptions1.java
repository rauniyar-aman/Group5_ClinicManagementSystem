 ...
 * @author amang
 */
public class View_Patient_Prescriptions1 extends javax.swing.JFrame {
    
    private static final java.util.logging.Logger logger = java.util.logging.Logger.getLogger(View_Patient_Prescriptions1.class.getName());

    /**
     * Creates new form Dashboard_Patient
     */
    public View_Patient_Prescriptions1() {
        initComponents();
    }
    ...
    public static void main(String args[]) {
        ...
        java.awt.EventQueue.invokeLater(() -> new View_Patient_Prescriptions1().setVisible(true));
    }
