...
public class Add_Doctor extends javax.swing.JFrame {
    ...
    private static final java.util.logging.Logger logger = java.util.logging.Logger.getLogger(Add_Doctor.class.getName());
    ...
    private void initComponents() {
        ...
        setPreferredSize(new java.awt.Dimension(721, 502));
        setResizable(false);
